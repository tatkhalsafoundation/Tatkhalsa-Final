  ...
  <body <?php body_class(); ?>>
    ...
    <div class="top-bar">
      <div class="container">
        <div class="top-bar-links">
          <a href="tel:+919877038520">📞 +91-98770-38520</a>
          <a href="https://wa.me/919877038520" target="_blank" rel="noopener noreferrer">💬 WhatsApp</a>
          <a href="mailto:info@tatkhalsa.in">📧 info@tatkhalsa.in</a>
        </div>
    ...
    <header class="header">
      <div class="container" style="position: relative; display: flex; align-items: center; justify-content: space-between;">
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo" style="z-index: 10">
