...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
    ...
    <div class="top-bar">
      <div class="container">
        <div class="top-bar-motto">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2L2 22h20L12 2zm0 3.99L19.53 19H4.47L12 5.99z"/>
          </svg>
          <span>ਏਕ ਹੀ ਕੀ ਸੇਵ ਸਭ ਹੀ ਕੋ ਗੁਰਦੇਵ ਏਕ ॥ Serving Humanity Through Seva</span>
        </div>
    ...
    <header class="header">
      <div class="container">
        ...
        <div class="header-nav-selector">
          <select onchange="if(this.value) window.location.href=this.value;" class="custom-nav-select" aria-label="Select Seva Page">
