...
?>
    ...
    <section
      id="about"
      style="
        background-image: url('<?php echo esc_url( get_theme_mod( 'tatkhalsa_about_hero_img', 'https://upload.wikimedia.org/wikipedia/commons/3/30/A_group_of_volunteers_helping_with_daily_food_preparation_for_Langar_at_the_Golden_Temple.jpg' ) ); ?>');
