      ...
      <div class="bento-grid" id="bentoGrid">
        ...
        <div class="bento-card type-orange" data-cat="youth">
          <div>
            ...
            <div class="card-top">
              <h3 class="card-title">Youth Kabaddi & Sports Clubs</h3>
              <div class="card-icon-sphere">🏆</div>
            </div>
            ...
            <p class="card-desc">
              Steering Punjab's bright youth away from drug abuse and screen isolation. We build local sports clubs, distribute fitness gears, and organize traditional Shashtar & sports events.
            </p>
          </div>
          <div class="card-actions">
...
<script>
  ...
  const projectDetails = {
    ...
    youth: {
      ...
      desc2: "We organize annual grand level sports events and tournaments, giving rewarding awards and encouraging healthy eating habits, clean living, and absolute mental toughness aligned with top moral disciplines.",
